...
<!-- Trong bài viết này, hãy cùng mình khám phá một số tính năng và chi tiết thiết kế mang tính tỉ mỉ, không dễ thấy tại *sveltevietnam.dev*. Ta sẽ không bàn nhiều đến mã nguồn (có thể sẽ được đề cập trong các bài viết sau) mà chỉ liệt kê sơ bộ hình thức và nguyên nhân, không theo một trình tự nhất định nào. -->
...
<img src={devToolsSlow3gImage} width="400" height="432" class="mx-auto max-w-full h-auto" />
...
- chuyển đổi giữa chế độ hiển thị sáng và tối vẫn hoạt động, vì thành phần này có hỗ trợ dự bị khả năng giao tiếp và điều hướng từ máy chủ bằng biểu mẫu HTML và query param. Đặc biệt hơn, hiệu ứng tương tác đóng, mở menu sổ xuổng là hoàn toàn bằng CSS,
...
<img src={disableJavascriptImage} class="max-w-full" width="1582" height="619" />
...
<img src={asciiPhoImage} class="mx-auto max-w-full" width="512" height="486" />
...
<img src={notFoundPageImage} class="max-w-full border" width="1024" height="576" />
...
<img src={blueScreenOfDeathImage} class="max-w-full border" width="1024" height="658" />
